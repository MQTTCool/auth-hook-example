...
/**
 * Default implementation of {@code IPermissionInfo} interface, which wraps a predefined
 * permissions set.
 */
class DefaultPermissionInfo implements IPermissionInfo {
    ...
    static class AuthorizationBuilder {
         ...
         */
        public final static IPermissionInfo ALL = new DefaultPermissionInfo() {
        ...
        public IPermissionInfo build() {
            return new DefaultPermissionInfo(contactableBrokers, subscribableTopics,
                publishableTopics);
        }
